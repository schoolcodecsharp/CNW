...
function WarehouseManagement() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load warehouses
      const warehousesRes = await axios.get(`${API_ENDPOINTS.daiLy.base}/kho/get-by-dai-ly/${currentDaily.maDaiLy}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingWarehouse) {
        // Update
        await axios.put(
          `${API_ENDPOINTS.daiLy.base}/kho/update/${editingWarehouse.maKho}`,
          formData
        );
        ...
        // Create
        await axios.post(
          `${API_ENDPOINTS.daiLy.base}/kho/create`,
          {
            loaiKho: 'daily',
            maDaiLy: maDaiLy,
            ...formData
  ...
  const handleDelete = async (warehouse) => {
    ...
    try {
      await axios.delete(`${API_ENDPOINTS.daiLy.base}/kho/delete/${warehouse.maKho}`);
